...
class Auth_Controller extends CI_Controller {
	...
	/**
	*
	*	To use authenticated user's profile in Views and Controllers
	*
	*/
	public $auth_profile = NULL;
	public $auth_contact = NULL;
	public $auth_address = NULL;
	...
	protected function _set_user_variables()
	{
		...
		$this->auth_profile_data = $this->auth_data->profile_data;
		$this->auth_contact_data = $this->auth_data->contact_data;
		$this->auth_address_data = $this->auth_data->address_data;
		...
		$data = [
			...
			'auth_profile'	=> $this->auth_profile_data,
			'auth_contact'	=> $this->auth_contact_data,
			'auth_address'	=> $this->auth_address_data
		];
		...
		$this->config->set_item( 'auth_profile',    $this->auth_profile );
		$this->config->set_item( 'auth_contact',    $this->auth_contact );
		$this->config->set_item( 'auth_address',    $this->auth_address );
