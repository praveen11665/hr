...
?>
	...
	<div>
		...
		<input value="appadmin" type="text" name="login_string" id="login_string" class="form_input" autocomplete="off" maxlength="255" />

		<br />

		<label for="login_pass" class="form_label">Password</label>
		<input value="Password!23" type="password" name="login_pass" id="login_pass" class="form_input password" <?php 
