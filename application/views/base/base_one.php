<!DOCTYPE html>
<html>
<!-- layouts_menu_side_compact.html 16:18 GMT -->
                    ...
                    <ul class="main-menu">
                        <li class="has-sub-menu">
                            ...
                            <div class="sub-menu-w">
                                ...
                                <div class="sub-menu-icon"><i class="os-icon os-icon-window-content"></i></div>
                        ...
                        <li class="has-sub-menu">
                            <a href="#">
                                <div class="icon-w"><i class="os-icon os-icon-delivery-box-2"></i></div>
                            </a>
                            <div class="sub-menu-w">
                        ...
                        <li class="has-sub-menu">
                            <a href="#">
                                <div class="icon-w"><i class="os-icon os-icon-newspaper"></i></div>
                            </a>
                            <div class="sub-menu-w">
                        ...
                        <li class="has-sub-menu">
                            <a href="#">
                                <div class="icon-w"><i class="os-icon os-icon-user-male-circle"></i></div>
                            </a>
                            <div class="sub-menu-w">
                                <div class="sub-menu-title">User Profiles</div>
                                <div class="sub-menu-icon"><i class="os-icon os-icon-user-male-circle"></i></div>
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li><a href="users_profile_big.html">Big Profile</a></li>
                                        <li><a href="users_profile_small.html">Compact Profile</a></li>
                        ...
                        <li class="has-sub-menu">
                            <a href="#">
                                <div class="icon-w"><i class="os-icon os-icon-tasks-checked"></i></div>
                            </a>
                            <div class="sub-menu-w">
                        ...
                        <li class="has-sub-menu">
                            <a href="#">
                                <div class="icon-w"><i class="os-icon os-icon-robot-1"></i></div>
                            </a>
                            <div class="sub-menu-w">
                                <div class="sub-menu-title">Icons</div>
                                <div class="sub-menu-icon"><i class="os-icon os-icon-robot-1"></i></div>
                                <div class="sub-menu-i">
                                    <ul class="sub-menu">
                                        <li><a href="icon_fonts_simple_line_icons.html">Simple Line Icons</a></li>
                                        <li><a href="icon_fonts_themefy.html">Themefy Icons</a></li>
