...
<form action="javascript:" data-action="<?php echo base_url($ActionUrl);?>" method="post" id="ajaxContentForm">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label>
			        <input type="checkbox" name="amount_based_on_formula"  id="amount_based_on_formula" onclick="showMultiContent(this, '.MaintainingSalaryContent', '.name')" value="1" <?php echo ($amount_based_on_formula =='1')?'checked':'' ?> checked=""/>            
	...
	<div class="row">	
		<div class="col-md-6">
		<span style="display:<?php echo($amount_based_on_formula);?> ? 'block' : 'none';"" class="MaintainingSalaryContent">
			<div class="form-group">
	...
	<div class="row">	
		<div class="col-md-6">
		<span style="display: none;" class="name">
			<div class="form-group">
