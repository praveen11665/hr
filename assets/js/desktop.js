$(function(){
	...
	//	TODO: Dynamic images user defined
	//				Transition time from settings
	//				Light/Dark Variation from settings
	//
	//	IDEA: Themes
	//----------------------------
	...
	var images = [
		base_url+"/assets/img/desk_bg_1.jpg",
		base_url+"/assets/img/desk_bg_2.jpg",
		base_url+"/assets/img/desk_bg_3.jpg",
		base_url+"/assets/img/desk_bg_4.jpg",
		base_url+"/assets/img/desk_bg_5.jpg",
	];
	...
	//----------------------------
	//	TASK MANAGEMENT
	//	Reference: http://www.jqueryscript.net/demo/Stylish-Card-Style-To-do-List-Plugin-For-jQuery-listrr/
	//	TODO: Make it PHP MYSQL SUPPORTED
	//	TODO: Create a library for codeigniter
	//----------------------------
